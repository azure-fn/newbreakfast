...
const BreakfastCheckin = () => {
  ...
  useEffect(() => {
    const loadExcelData = async () => {
      const response = await fetch('https://docs.google.com/spreadsheets/d/12tUqfzccV8ffb-328eNDGFNgedKHycvxlB7X8e6gu28/gviz/tq?tqx=out:csv');// Đảm bảo file guests.xlsx nằm trong thư mục public
